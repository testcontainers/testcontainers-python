...
@pytest.mark.parametrize(
    "platform, expected", [("linux", "linux"), ("linux2", "linux"), ("darwin", "mac"), ("win32", "win")]
)
def test_os_name(monkeypatch: pytest.MonkeyPatch, platform: str, expected: str) -> None:
...
def test_is_arm(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_inside_container(monkeypatch: pytest.MonkeyPatch) -> None:
