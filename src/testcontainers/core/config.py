...
def get_docker_socket() -> str:
    ...
    try:
        ...
        # if adapter does not define socket_path, we return default anyway, so ignore types
        socket_path = client.api.get_adapter(client.api.base_url).socket_path  # type: ignore[attr-defined]
