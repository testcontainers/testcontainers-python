...
[Creating a MySQL container](../../modules/mysql/tests/test_mysql.py) inside_block:runMySQLContainer
...
[Example of Init script](../../modules/mysql/tests/seeds/01-schema.sql)
...
[Get connection string](../../modules/mysql/tests/test_mysql.py) inside_block:connectionString
